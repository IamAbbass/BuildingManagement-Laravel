                    ...
                    data-pagination="true" data-page-list="[10, 25, 50, 100, ALL]">
                        ...
                        <tbody>
                            ...
                            <tr class=" " data-id="13">
                                ...
                                <td>
                                <span class="item-amount d-none d-sm-block text-sm "><a href="/expensehead/{{$item->id}}/expense/create" class="item-title text-color ">{{$item->name}}</a></span>
                                </td>
                                <td class="flex">
                               ...
                               {{ $item->description}}
                                ...
                                <td>
                                    ...
                                    <a href="/expensehead/{{$item->id}}/expense" class="btn gd-warning text-white btn-rounded">Add Expense</a>
                                        ...
                                        <a class="dropdown-item" href="/expensehead/{{$item->id}}/edit">
                                                Edit
                                            </a>
                                            <a class="dropdown-item" href="#">
                                                show
                                            </a>
                                        <form action="/expensehead/{{$item->id}}" method="post">
                                                @csrf
                                                @method('DELETE')
