...
<body>
    ...
    <div class="container">
        ...
        <br />
        <small class="text-center">Plot No. 1185/G, Stadium Road, Block 10-A, Gulshan-e-Iqbal, Karachi</small>
        </h4>
        <h4 class="text-center flat-no">{{ $expense->head->name }}</h4>
        ...
        <div class="row">
            <div class="one_two bold"><span>Name:</span></div>
            <div class="one_two"><span>{{ $expense->name }}</span></div>
            <div class="clearfix"></div>
        </div>

        <div class="row">
            <div class="one_two bold"><span>Description:</span></div>
        ...
        <div class="row">
            ...
            <div class="one_two capitalize">
                <span class="amount">
                    ...
                    <br/>
                    {{ convert_number_to_words($expense->amount)." Only." }}
                </span>
            </div>
            <div class="clearfix"></div>
        </div>
